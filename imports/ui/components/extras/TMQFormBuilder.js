			...
			$("#tmq-form-builder-center").droppable({
				drop: function (event, ui) {
					...
					switch ($(ui.draggable).data("form")) {
						case 'heading':
							elem = '<h2 style="width: 100%; border-bottom:1px solid #cacaca;" id="heading' + id + '" contenteditable="true">Heading</h2><div class="tmq-form-builder-close" id="close' + id + '" data-close="heading' + id + '"><i class="fa fa-times" aria-hidden="true" style="position:relative;top:-2px;"></i></div><div class="tmq-form-builder-edit" id="edit' + id + '" data-edit="heading' + id + '"><i class="fa fa-pencil" aria-hidden="true" style="position:relative;top:-2px;"></i></div>';
							break;
						case 'textfield':
							elem = '<div style="width: 100%; "><label contenteditable="true" style="width: 100%; text-align:left">Textfield:</label><input readonly="readonly" style="width:100%;" id="textfield' + id + '" type="text" placeholder="" /></div><div class="tmq-form-builder-close" id="close' + id + '" data-close="textfield' + id + '"><i class="fa fa-times" aria-hidden="true" style="position:relative;top:-2px;"></i></div><div class="tmq-form-builder-edit" id="edit' + id + '" data-edit="textfield' + id + '"><i class="fa fa-pencil" aria-hidden="true" style="position:relative;top:-2px;"></i></div>';
							break;
						case 'emailfield':
							elem = '<div style="width: 100%; "><label contenteditable="true" style="width: 100%; text-align:left">Emailadd:</label><input readonly="readonly" style="width:100%;" id="textfield' + id + '" type="email" placeholder="" /></div><div class="tmq-form-builder-close" id="close' + id + '" data-close="emailfield' + id + '"><i class="fa fa-times" aria-hidden="true" style="position:relative;top:-2px;"></i></div><div class="tmq-form-builder-edit" id="edit' + id + '" data-edit="emailfield' + id + '"><i class="fa fa-pencil" aria-hidden="true" style="position:relative;top:-2px;"></i></div>';
							break;
						case 'textarea':
							elem = '<div style="width: 100%; "><label contenteditable="true" style="width: 100%; text-align:left">Textarea:</label><textarea readonly="readonly" id="textarea' + id + '" style="resize:vertical;width:100%;"></textarea></div><div class="tmq-form-builder-close" id="close' + id + '" data-close="textarea' + id + '"><i class="fa fa-times" aria-hidden="true" style="position:relative;top:-2px;"></i></div><div class="tmq-form-builder-edit" id="edit' + id + '" data-edit="textarea' + id + '"><i class="fa fa-pencil" aria-hidden="true" style="position:relative;top:-2px;"></i></div>';
							break;
						case 'dropdown':
							elem = '<div style="width: 100%; "><label contenteditable="true" style="width: 100%; text-align:left">Dropdown:</label><select readonly="readonly" id="dropdown' + id + '"><option value="true">TRUE</option><option value="false">FALSE</option></select></div><div class="tmq-form-builder-close" id="close' + id + '" data-close="dropdown' + id + '"><i class="fa fa-times" aria-hidden="true" style="position:relative;top:-2px;"></i></div><div class="tmq-form-builder-edit" id="edit' + id + '" data-edit="dropdown' + id + '"><i class="fa fa-pencil" aria-hidden="true" style="position:relative;top:-2px;"></i></div>';
							break;
						case 'radio':
							elem = '<div style="width: 100%; text-align: left;"><label contenteditable="true" style="width: 100%; text-align:left">Radio Buttons:</label><br /><input type="radio" id="radio' + id + '" name="radio' + id + '" value="true" /> <span>TRUE</span><br><input type="radio" name="radio' + id + '" id="radio' + id + '" value="false" /> <span>FALSE</span><br></div><div class="tmq-form-builder-close" id="close' + id + '" data-close="radio' + id + '"><i class="fa fa-times" aria-hidden="true" style="position:relative;top:-2px;"></i></div><div class="tmq-form-builder-edit" id="edit' + id + '" data-edit="radio' + id + '"><i class="fa fa-pencil" aria-hidden="true" style="position:relative;top:-2px;"></i></div>';
							break;
						case 'checkbox':
							elem = '<div style="width: 100%; text-align: left; "><label contenteditable="true" style="width: 100%; text-align:left">Checkboxes:</label><br /><input type="checkbox" id="checkbox' + id + '" name="checkbox' + id + '" value="true" /> <span>TRUE</span><br><input type="checkbox" name="checkbox' + id + '" id="checkbox' + id + '" value="false" /> <span>FALSE</span><br></div><div class="tmq-form-builder-close" id="close' + id + '" data-close="checkbox' + id + '"><i class="fa fa-times" aria-hidden="true" style="position:relative;top:-2px;"></i></div><div class="tmq-form-builder-edit" id="edit' + id + '" data-edit="checkbox' + id + '"><i class="fa fa-pencil" aria-hidden="true" style="position:relative;top:-2px;"></i></div>';
							break;
						case 'date':
							elem = '<div style="width: 100%; "><label contenteditable="true" style="width: 100%; text-align:left">Date:</label><input readonly="readonly" type="text" id="datepicker' + id + '" style="width:100%;" class="datepicker" /></div><div class="tmq-form-builder-close" id="close' + id + '" data-close="datepicker' + id + '"><i class="fa fa-times" aria-hidden="true" style="position:relative;top:-2px;"></i></div><div class="tmq-form-builder-edit" id="edit' + id + '" data-edit="datepicker' + id + '"><i class="fa fa-pencil" aria-hidden="true" style="position:relative;top:-2px;"></i></div>';
							break;
						case 'paragraph':
							elem = '<div><p style="width: 100%; text-indent: 50px;" id="paragraph' + id + '" contenteditable="true">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In feugiat justo sed elit semper imperdiet. Nulla eu sapien' +
