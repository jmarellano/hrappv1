...
export const JOB_SITES = [
    ...
    { value: 'baguiojobs.net', label: 'baguiojobs.net' },
    { value: 'pangasinanjobs.net', label: 'pangasinanjobs.net' },
    { value: 'zambalesjobs.net', label: 'zambalesjobs.net' },
    { value: 'subicjobs.net', label: 'subicjobs.net' },
    { value: 'bataanjobs.net', label: 'bataanjobs.net' },
    { value: 'pampangajobs.net', label: 'pampangajobs.net' },
    { value: 'bulacanjobs.net', label: 'bulacanjobs.net' },
    { value: 'metromanilajobs.net', label: 'metromanilajobs.net' },
    { value: 'cavitejobs.net', label: 'cavitejobs.net' },
    { value: 'lagunajobs.net', label: 'lagunajobs.net' },
    { value: 'batangasjobs.net', label: 'batangasjobs.net' },
    { value: 'bicoljobs.net', label: 'bicoljobs.net' },
    { value: 'boracayjobs.net', label: 'boracayjobs.net' },
    { value: 'iloilojobs.net', label: 'iloilojobs.net' },
    { value: 'cebujobs.net', label: 'cebujobs.net' },
    { value: 'bacolodjobs.net', label: 'bacolodjobs.net' },
    { value: 'dumaguetejobs.net', label: 'dumaguetejobs.net' },
    { value: 'zamboangajobs.net', label: 'zamboangajobs.net' },
    { value: 'davaojobs.net', label: 'davaojobs.net' },
    { value: 'hireme.ph', label: 'hireme.ph' },
    { value: 'sulitpinas.com', label: 'sulitpinas.com' },
    { value: 'hiringvenue.com', label: 'hiringvenue.com' },
    { value: 'worksvianet.com', label: 'worksvianet.com' },
    { value: 'sheryna.ph', label: 'sheryna.ph' },
    { value: 'juantambayan.com', label: 'juantambayan.com' },
    { value: 'ph.jora.com', label: 'ph.jora.com' },
    { value: 'postjobfree.com', label: 'postjobfree.com' },
    { value: 'freshgrad.ph', label: 'freshgrad.ph' },
    { value: 'jobfinderph.com', label: 'jobfinderph.com' },
    { value: 'ph.gigajob.com', label: 'ph.gigajob.com' },
    { value: 'jobhero.com', label: 'jobhero.com' },
    { value: 'muamat.com', label: 'muamat.com' },
    { value: 'jobs4jobs.com', label: 'jobs4jobs.com' },
    { value: 'itpinoy.com', label: 'itpinoy.com' },
];