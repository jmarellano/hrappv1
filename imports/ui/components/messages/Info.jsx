...
class Info extends Component {
  ...
  handleInputChange(event) {
    ...
    if (target) {
      ...
      if (this.setState) this.setState({ [target.name]: value });
    }
  }
  ...
  render() {
    return (
      <a
        className="link badge badge-success text-light mr-1"
        data-tip="Edit Info"
      >
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  <div className="form-horizontal mt-3">
                    ...
                    <div className="form-group">
                      <label className="col-sm-3 control-label" htmlFor="city">
                        City
                      </label>
                      <div className="col-sm-12">
                        <input
                    ...
                    <div className="form-group">
                      <label className="col-sm-3 control-label" htmlFor="state">
                        State
                      </label>
                      <div className="col-sm-12">
                        <input
                    ...
                    <div className="form-group">
                      <label className="col-sm-3 control-label" htmlFor="zip">
                        Zip Code
                      </label>
                      <div className="col-sm-12">
                        <input
...
export default withTracker(() => {
  return {
    categories: CategoriesDB.find({}, { sort: { category: 1 } })
      .fetch()
